...
<AppCTA message="Conjugito shows vosotros and ustedes forms side by side for all tenses." />
...
**Using Conjugito**: the *Vosotros* setting in the app can be toggled on or off, so you can focus on the system that applies to your target dialect.
...
<AppCTA message="Toggle vosotros on or off in Conjugito to match your target dialect." />
